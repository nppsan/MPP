				   ...
				   <hr>
					...
					<div class="form-group row">
					 ...
					 <div class="form-group row">
					  ...
					  <div class="col-sm-10">
                                              <button type="button" id="btn1" class="btn btn-primary shadow-primary px-5"><i class="icon-lock"></i> SAVE & NEXT</button>
					  </div>
					</div>
					<!--</form>-->
				 </div>
			     ...
			     <div class="card-body">
				   ...
				   <hr>
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-10">
                                              <input type="text" autocomplete="consGstnAadhar" name="consGstnAadhar" class="form-control" id="consGstnAadhar" placeholder="Enter Consignee GSTN/Aadhar">
					  </div>
					</div>
					 <div class="form-group row">
					  <label for="input-1" class="col-sm-2 col-form-label"></label>
